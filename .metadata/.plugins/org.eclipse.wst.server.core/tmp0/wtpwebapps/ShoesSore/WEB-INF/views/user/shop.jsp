...
<body>
	<c:forEach var="item" items="${sanphamtheoloaiModel}">
		...
		<div class="wrap">
			...
			<div class="cont span_2_of_3">
				<div class="mens-toolbar">
					<div class="sort">
						<div class="sort-by">
							<label>Sắp xếp theo</label> <select>
					...
					<div class="pager">
						...
						<ul class="dc_pagination dc_paginationA dc_paginationA06">
							...
							<c:forEach var="item" begin = "1" end= "${ phantrangModel.totalPage}" varStatus="loop">
							
						
								<li><a
										href="<c:url value = "/shop/${idloaisanpham}/${loop.index}"/>">
										${loop.index }</a></li>
