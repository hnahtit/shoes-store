...
<div class="single">
		...
		<div class="cont span_2_of_3">
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="<c:url value = "/assets/user/images/myimages/${sanpham.link1 }"/>" />
			...
			<div class="cont1 span_2_of_a1">
				<h3 class="m_3">>${sanpham.tensanpham }</h3>
				
				<div class="price_single">
							  <span class="reducedfrom">$66.00</span>
							  <span class="actual">${sanpham.gia }.000 VNĐ</span><a href="#">click for offer</a>
							</div>
				<ul class="options">
				...
				<ul class="add-to-links">
    			   <li><img src="<c:url value = "/assets/user/images/wish.png"/>" alt=""/><a href="#">Add to wishlist</a></li>
    			</ul>
         ...
         <ul id="flexiselDemo3">
			<li><img src="<c:url value = "/assets/user/images/pic11.jpg"/>" /><div class="grid-flex"><a href="#">Bloch</a><p>Rs 850</p></div></li>
			<li><img src="<c:url value = "/assets/user/images/pic10.jpg"/>" /><div class="grid-flex"><a href="#">Capzio</a><p>Rs 850</p></div></li>
			<li><img src="<c:url value = "/assets/user/images/pic9.jpg"/>" /><div class="grid-flex"><a href="#">Zumba</a><p>Rs 850</p></div></li>
			<li><img src="<c:url value = "/assets/user/images/pic8.jpg"/>" /><div class="grid-flex"><a href="#">Bloch</a><p>Rs 850</p></div></li>
			<li><img src="<c:url value = "/assets/user/images/pic7.jpg"/>" /><div class="grid-flex"><a href="#">Capzio</a><p>Rs 850</p></div></li>
		 </ul>
	...
	<script type="text/javascript" src="<c:url value = "/assets/user/js/jquery.flexisel.js"/>"></script>
	 <div class="toogle">
